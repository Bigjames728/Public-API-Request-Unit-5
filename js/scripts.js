...
//Below is a function that adds the next and previous buttons to the modal window - still need to finish adding functionality to buttons.
function nextPrevModal() {
    ...
    modal.insertAdjacentHTML('afterend', nextBtn);
